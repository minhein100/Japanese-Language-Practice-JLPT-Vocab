document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizQuestionsData = [
        '<p>1. 固定観念に基づく<span class="blank" data-correct-answer="偏見"></span> は、建設的な議論を妨げる。</p>',
        '<p>2. 山頂からの<span class="blank" data-correct-answer="眺望"></span> は素晴らしく、遠くまで見渡せた。</p>',
        '<p>3. 有名な俳優による詩の<span class="blank" data-correct-answer="朗読"></span> 会が開催された。</p>',
        '<p>4. 工場には最新鋭の生産<span class="blank" data-correct-answer="装置"></span> が導入された。</p>',
        '<p>5. 遠くの山が近くに見えるのは、目の<span class="blank" data-correct-answer="錯覚"></span> だ。</p>'
    ];

    const questionsContainer = document.getElementById('questions'); // Corrected variable name for clarity
    const answers = ["朗読", "錯覚", "郊外", "装置", "偏見", "眺望"];
